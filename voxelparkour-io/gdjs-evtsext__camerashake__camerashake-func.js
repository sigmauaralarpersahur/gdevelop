...
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).setNumber(1 / (Number(eventsFunctionContext.getArgument("ShakePeriod")) || 0));
}
}
...
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(5).setNumber((Number(eventsFunctionContext.getArgument("Duration")) || 0));
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(10).setNumber(0);
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(11).setNumber((Number(eventsFunctionContext.getArgument("Duration")) || 0));
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(1).setNumber(Math.abs((Number(eventsFunctionContext.getArgument("AmplitudeX")) || 0)));
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(2).setNumber(Math.abs((Number(eventsFunctionContext.getArgument("AmplitudeY")) || 0)));
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(3).setNumber((Number(eventsFunctionContext.getArgument("AmplitudeAngle")) || 0));
}
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(4).setNumber(1 + (Number(eventsFunctionContext.getArgument("AmplitudeZoom")) || 0) / 100);
}
